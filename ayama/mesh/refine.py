...
The surface ĀYĀMA delivers is metrically anchored but geometrically soft: its
...
`ayama refine` measures edge F1 and nDSM MAE against a reference and reports
